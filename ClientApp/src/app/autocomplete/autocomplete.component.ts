...
export class AutocompleteComponent implements OnInit, OnChanges, AfterViewInit, ControlValueAccessor {
  ...
  private manualOpen : boolean | undefined;
  private manualClose: boolean | undefined;
  ...
  @Input() public initialValue!: never; // set initial value
  @Input() public iconName = ''; // material iconName
  /**
   ...
   * @param value
   */
  public setInitialValue(value: never) {
