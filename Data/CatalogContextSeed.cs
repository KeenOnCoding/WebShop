...
{
    public async Task SeedAsync(ApplicationDbContext context, IWebHostEnvironment env, IOptions<CatalogSettings> settings, ILogger<CatalogContextSeed> logger)
    {
    ...
    private IEnumerable<CatalogItem> GetCatalogItemsFromFile(string contentRootPath, ApplicationDbContext context, ILogger<CatalogContextSeed> logger)
    {
